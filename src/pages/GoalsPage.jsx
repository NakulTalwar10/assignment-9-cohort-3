...
import { loadGoals, addGoal, toggleGoal, toggleGoalPriority, deleteGoal } from "../utils/store";

const GoalsPage = ({ darkMode }) => {
      ...
      <div className="p-3 sm:p-5">
        <div className="mb-6 sm:mb-8">
          ...
          <p className={`mt-1 text-xs sm:text-sm transition-colors ${
            ...
            Track your goals and aspirations.
          </p>
        </div>
            ...
            <ul className="divide-y divide-slate-800/50">
              {sorted.map((goal) => (
                ...
                >
                  ...
                  >
                    <svg className="w-4 h-4" fill={goal.priority ? "currentColor" : "none"} viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
